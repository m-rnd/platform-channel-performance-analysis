...
final GetPlatformVersionDartFunc _nativeGetPlatformVersion = _nativeAddLib
    .lookup<NativeFunction<GetPlatformVersionNativeFunc>>("GetPlatformVersion")
    .asFunction<GetPlatformVersionDartFunc>();

final GetPlatformVersionDartFunc _nativeGetPlatformVersionUi = _nativeAddLib
    .lookup<NativeFunction<GetPlatformVersionNativeFunc>>(
        "GetPlatformVersionUi")
    .asFunction<GetPlatformVersionDartFunc>();
